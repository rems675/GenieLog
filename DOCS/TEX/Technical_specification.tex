...
\begin{bf}LongInt\&\end{bf}: Is the objet local.\\
 ...
 \chapter*{Diagram}  
   \addcontentsline{toc}{chapter}{UML Diagram} % pour ajouter l'introduction à la table des matières
	
	\begin{figure}[!h] %on ouvre l'environnement figure
	\includegraphics[width=15cm]{fig128013.png} %ou image.png, .jpeg etc.
	\caption{Use case diagram} %la légende
	\label{Use case diagram} %l'étiquette pour faire référence à cette image
